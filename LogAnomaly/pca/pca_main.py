...
def load_HDFS(struct_log, train_ratio=0.5):
    dict={'INFO':0,'ERROR':1,'WARN':2,'DEBUG':3,'TRACE':4,'FATAL':5}
    ...
    for idx, row in struct_log.iterrows():
        ...
        for blk_Id in blkId_set:
            ...
            data_dict[blk_Id].append(dict[row['Type']])
...
if __name__ == '__main__':
    ## 1. 加载日志文件 提取特征向量
    print("读取log数据")
    log_file = './data/HDFS/data_train.csv'
